...
Copyright (c) 2026 battle-doll. All rights reserved except for the limited grant
below.

The WAV files under `assets/audio/` are not licensed under the MIT License.
Permission is granted to use, copy, and redistribute the unmodified WAV files
...
Broader redistribution and commercial permissions are intentionally reserved
until the generation-model licensor confirms those rights in writing.
